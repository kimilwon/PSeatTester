...
namespace PSeatTester
{
    ...
    public class RL_PSeat_Legrest_Up
    {
        ...
        public const byte NotRelaxType = 0x11;
    ...
    public class RL_PSeat_Legrest_Down
    {
        ...
        public const byte NotRelaxType = 0x12;
    ...
    public class RL_PSeat_Recline_Bwd
    {
        ...
        public const byte NotRelaxType = 0x13;
        static public byte[] MoveData
        {
            get
            {
    ...
    public class RL_PSeat_LegrestExt_Down
    {
        ...
        public const byte NotRelaxType = 0x14;
        static public byte[] MoveData
        {
            get
            {
    ...
    public class RL_PSeat_Relax_Up
    {
        ...
        public const short Pos = 3;
        public const byte RelaxType = 0x1a;
        public const byte NotRelaxType = 0x15;
        static public byte[] MoveData
        {
            get
            {
    ...
    public class RL_PSeat_Relax_Down
    {
        ...
        public const short Pos = 3;
        public const byte RelaxType = 0x1b;
        public const byte NotRelaxType = 0x16;
    ...
    public class RL_PSeat_Height_Up
    {
        ...
        public const byte NotRelaxType = 0x19;
        static public byte[] MoveData
        {
            get
            {
    ...
    public class RL_PSeat_Height_Down
    {
        ...
        public const byte NotRelaxType = 0x1a;
    ...
    public class RL_VirtualLimit_All
    {
        ...
        public const byte ID_NotRelaxType = 0xa3;

        public const short Data_Pos = 5;
        public const byte Data_RelaxType = 0x00;
        public const byte Data_NotRelaxType = 0x00;

        static public byte[] Clear
        {
            get
            {
                byte[] Data = { 0x05, 0x31, 0x01, 0x12, 0x00, 0x80, 0x00, 0x00 };
    ...
    public class RL_VirtualLimit_Legrest
    {
        ...
        public const byte Data_NotRelaxType = 0x01;
        static public byte[] Clear
        {
            get
            {
                byte[] Data = { 0x05, 0x31, 0x01, 0x12, 0x00, 0x81, 0x00, 0x00 };
    ...
    public class RL_VirtualLimit_LegrestExt
    {
        ...
        public const byte Data_NotRelaxType = 0x2;
        static public byte[] Clear
        {
            get
            {
                byte[] Data = { 0x05, 0x31, 0x01, 0x12, 0x00, 0x82, 0x00, 0x00 };
    ...
    public class RL_VirtualLimit_Relax
    {
        ...
        public const byte Data_NotRelaxType = 0x03;
        static public byte[] Clear
        {
            get
            {
                byte[] Data = { 0x05, 0x31, 0x01, 0x12, 0x00, 0x83, 0x00, 0x00 };
    ...
    public class RL_VirtualLimit_Recline
    {
        ...
        public const byte Data_NotRelaxType = 0x04;
        static public byte[] Clear
        {
            get
            {
                byte[] Data = { 0x05, 0x31, 0x02, 0x12, 0x00, 0x84, 0x00, 0x00 };
    ...
    public class RL_VirtualLimit_Slide
    {
        ...
        public const byte Data_NotRelaxType = 0x02;
        static public byte[] Clear
        {
            get
            {
    ...
    public class RL_VirtualLimit_Tilt
    {
        ...
        public const byte Data_NotRelaxType = 0x07;
        static public byte[] Clear
        {
            get
            {
    ...
    public class RL_VirtualLimit_Height
    {
        ...
        public const byte Data_NotRelaxType = 0x06;
        static public byte[] Clear
        {
            get
            {
    ...
    public class CanMap
    {
        ...
        public VirtualLimitState RLVirtualLimitDataRead()
        {
            ...
            else
            {
                ...
                else if (MultiFreameData[0, 5] == 11) Data.LegrestExt = VirtualLimitValue.DuringSetOperationAndLotLimitSet;
                else if (MultiFreameData[0, 5] == 12) Data.LegrestExt = VirtualLimitValue.DuringSetOperationAndlimitSet;
        ...
        public VirtualLimitState RRVirtualLimitDataRead()
        {
            ...
            else
            {
                ...
                else if (MultiFreameData[1, 5] == 11) Data.LegrestExt = VirtualLimitValue.DuringSetOperationAndLotLimitSet;
                else if (MultiFreameData[1, 5] == 12) Data.LegrestExt = VirtualLimitValue.DuringSetOperationAndlimitSet;
        ...
        public __CanOutMessage CheckCanOutMessage(OUT_CAN_LIST Msg, bool OnOff)
        {
            ...
            switch (Msg)
            {
                case OUT_CAN_LIST.RL_PSeat_Relax_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Relax_Up.Pos] = RL_PSeat_Relax_Up.NotRelaxType;
                    else Pos.Data[RL_PSeat_Relax_Up.Pos] = RL_PSeat_Relax_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Relax_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Relax_Down.Pos] = RL_PSeat_Relax_Down.NotRelaxType;
                    else Pos.Data[RL_PSeat_Relax_Down.Pos] = RL_PSeat_Relax_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Legrest_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Legrest_Up.Pos] = RL_PSeat_Legrest_Up.NotRelaxType;
                    else Pos.Data[RL_PSeat_Legrest_Up.Pos] = RL_PSeat_Legrest_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Legrest_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Legrest_Down.Pos] = RL_PSeat_Legrest_Down.NotRelaxType;
                    else Pos.Data[RL_PSeat_Legrest_Down.Pos] = RL_PSeat_Legrest_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Recline_Fwd:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Recline_Fwd.Pos] = RL_PSeat_Recline_Fwd.NotRelaxType;
                    else Pos.Data[RL_PSeat_Recline_Fwd.Pos] = RL_PSeat_Recline_Fwd.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Recline_Bwd:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Recline_Bwd.Pos] = RL_PSeat_Recline_Bwd.NotRelaxType;
                    else Pos.Data[RL_PSeat_Recline_Bwd.Pos] = RL_PSeat_Recline_Bwd.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_LegrestExt_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_LegrestExt_Up.Pos] = RL_PSeat_LegrestExt_Up.NotRelaxType;
                    else Pos.Data[RL_PSeat_LegrestExt_Up.Pos] = RL_PSeat_LegrestExt_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_LegrestExt_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_LegrestExt_Down.Pos] = RL_PSeat_LegrestExt_Down.NotRelaxType;
                    else Pos.Data[RL_PSeat_LegrestExt_Down.Pos] = RL_PSeat_LegrestExt_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Height_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Height_Up.Pos] = RL_PSeat_Height_Up.NotRelaxType;
                    else Pos.Data[RL_PSeat_Height_Up.Pos] = RL_PSeat_Height_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_PSeat_Height_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RL_PSeat_Height_Down.Pos] = RL_PSeat_Height_Down.NotRelaxType;
                    else Pos.Data[RL_PSeat_Height_Down.Pos] = RL_PSeat_Height_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Relax_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Relax_Up.Pos] = RR_PSeat_Relax_Up.NotRelaxType;
                    else Pos.Data[RR_PSeat_Relax_Up.Pos] = RR_PSeat_Relax_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Relax_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Relax_Down.Pos] = RR_PSeat_Relax_Down.NotRelaxType;
                    else Pos.Data[RR_PSeat_Relax_Down.Pos] = RR_PSeat_Relax_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Legrest_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Legrest_Up.Pos] = RR_PSeat_Legrest_Up.NotRelaxType;
                    else Pos.Data[RR_PSeat_Legrest_Up.Pos] = RR_PSeat_Legrest_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Legrest_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Legrest_Down.Pos] = RR_PSeat_Legrest_Down.NotRelaxType;
                    else Pos.Data[RR_PSeat_Legrest_Down.Pos] = RR_PSeat_Legrest_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Recline_Fwd:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Recline_Fwd.Pos] = RR_PSeat_Recline_Fwd.NotRelaxType;
                    else Pos.Data[RR_PSeat_Recline_Fwd.Pos] = RR_PSeat_Recline_Fwd.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Recline_Bwd:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Recline_Bwd.Pos] = RR_PSeat_Recline_Bwd.NotRelaxType;
                    else Pos.Data[RR_PSeat_Recline_Bwd.Pos] = RR_PSeat_Recline_Bwd.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_LegrestExt_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_LegrestExt_Up.Pos] = RR_PSeat_LegrestExt_Up.NotRelaxType;
                    else Pos.Data[RR_PSeat_LegrestExt_Up.Pos] = RR_PSeat_LegrestExt_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_LegrestExt_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_LegrestExt_Down.Pos] = RR_PSeat_LegrestExt_Down.NotRelaxType;
                    else Pos.Data[RR_PSeat_LegrestExt_Down.Pos] = RR_PSeat_LegrestExt_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Height_Up:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Height_Up.Pos] = RR_PSeat_Height_Up.NotRelaxType;
                    else Pos.Data[RR_PSeat_Height_Up.Pos] = RR_PSeat_Height_Up.RelaxType;
                    break;
                case OUT_CAN_LIST.RR_PSeat_Height_Down:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                        Pos.Data[RR_PSeat_Height_Down.Pos] = RR_PSeat_Height_Down.NotRelaxType;
                    else Pos.Data[RR_PSeat_Height_Down.Pos] = RR_PSeat_Height_Down.RelaxType;
                    break;
                case OUT_CAN_LIST.RL_VirtualLimit_All:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RL_VirtualLimit_All.ID_Pos] = RL_VirtualLimit_All.ID_NotRelaxType;
                        Pos.Data[RL_VirtualLimit_All.Data_Pos] = RL_VirtualLimit_All.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RR_VirtualLimit_All:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RR_VirtualLimit_All.ID_Pos] = RR_VirtualLimit_All.ID_NotRelaxType;
                        Pos.Data[RR_VirtualLimit_All.Data_Pos] = RR_VirtualLimit_All.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RL_VirtualLimit_Relax:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RL_VirtualLimit_Relax.ID_Pos] = RL_VirtualLimit_Relax.ID_NotRelaxType;
                        Pos.Data[RL_VirtualLimit_Relax.Data_Pos] = RL_VirtualLimit_Relax.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RR_VirtualLimit_Relax:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RR_VirtualLimit_Relax.ID_Pos] = RR_VirtualLimit_Relax.ID_NotRelaxType;
                        Pos.Data[RR_VirtualLimit_Relax.Data_Pos] = RR_VirtualLimit_Relax.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RL_VirtualLimit_Recline:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RL_VirtualLimit_Recline.ID_Pos] = RL_VirtualLimit_Recline.ID_NotRelaxType;
                        Pos.Data[RL_VirtualLimit_Recline.Data_Pos] = RL_VirtualLimit_Recline.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RR_VirtualLimit_Recline:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RR_VirtualLimit_Recline.ID_Pos] = RR_VirtualLimit_Recline.ID_NotRelaxType;
                        Pos.Data[RR_VirtualLimit_Recline.Data_Pos] = RR_VirtualLimit_Recline.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RL_VirtualLimit_Legrest:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RL_VirtualLimit_Legrest.ID_Pos] = RL_VirtualLimit_Legrest.ID_NotRelaxType;
                        Pos.Data[RL_VirtualLimit_Legrest.Data_Pos] = RL_VirtualLimit_Legrest.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RR_VirtualLimit_Legrest:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RR_VirtualLimit_Legrest.ID_Pos] = RR_VirtualLimit_Legrest.ID_NotRelaxType;
                        Pos.Data[RR_VirtualLimit_Legrest.Data_Pos] = RR_VirtualLimit_Legrest.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RL_VirtualLimit_LegrestExt:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RL_VirtualLimit_LegrestExt.ID_Pos] = RL_VirtualLimit_LegrestExt.ID_NotRelaxType;
                        Pos.Data[RL_VirtualLimit_LegrestExt.Data_Pos] = RL_VirtualLimit_LegrestExt.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RR_VirtualLimit_LegrestExt:
                    ...
                    if (ModelTypeToRelax == MODELTYPE.NOT_RELAX)
                    {
                        Pos.Data[RR_VirtualLimit_LegrestExt.ID_Pos] = RR_VirtualLimit_LegrestExt.ID_NotRelaxType;
                        Pos.Data[RR_VirtualLimit_LegrestExt.Data_Pos] = RR_VirtualLimit_LegrestExt.Data_NotRelaxType;
                    }
                    else
                    {
                ...
                case OUT_CAN_LIST.RL_VirtualLimit_GetMessage:
                    ...
                    else Pos.Data = RL_VirtualLimit_GetMessage.GetRequestRelax;
                    break;
                case OUT_CAN_LIST.RR_VirtualLimit_GetMessage:
                    ...
                    else Pos.Data = RR_VirtualLimit_GetMessage.GetRequestRelax;
                    break;
                default:
                    Pos.ID = -1;
                    break;
                                    ...
                                    if (300 <= (PSeatContrilMsgSendLast - PSeatContrilMsgSendFirst))
                                    {
                                        if (VirtualLimitSetFalg == false)
                                        {
                                            if (CanOutPosCount == 0)
                                            {
                                                ...
                                                //if ((MultiFrameRead[0] == false) && (MultiFrameRead[1] == false))
                                                //{
                                                RLoMsg.ID = RL_VirtualLimit_GetMessage.RequestAddr;
                                                RLoMsg.Length = 8;
                                            ...
                                            else if (CanOutPosCount == 1)
                                            {
                                                ...
                                                {
                                                    CanOutPosCount++;
                                                    if (1 < CanOutPosCount) CanOutPosCount = 0;
                                                }
                            ...
                            if (CanOutPosCount == 0)
                            {
                                if (Msg.DATA[0] == 0x10)
                                {
                                    ...
                                    if ((Msg.DATA[2] == 0x71) && (Msg.DATA[4] == 0x12) && ((Msg.DATA[5] == 0xa6) || (Msg.DATA[5] == 0xa7)))
                                    {
                                        ...
                                        //MultiFreameData[xPos, MultiFreameDataPos[xPos]++] = Msg.DATA[5];
        ...
        public void CanDataOutput(OUT_CAN_LIST Msg, byte Data)
        {
            if ((Msg != OUT_CAN_LIST.RL_PSeat_Relax_Up) && (Msg != OUT_CAN_LIST.RL_PSeat_Relax_Down) && (Msg != OUT_CAN_LIST.RL_PSeat_Recline_Fwd) && (Msg != OUT_CAN_LIST.RL_PSeat_Recline_Bwd) &&
                ...
                (Msg != OUT_CAN_LIST.RL_PSeat_Height_Up) && (Msg != OUT_CAN_LIST.RL_PSeat_Height_Down) &&
                ...
                (Msg != OUT_CAN_LIST.RR_PSeat_Height_Up) && (Msg != OUT_CAN_LIST.RR_PSeat_Height_Down) &&
                ...
                (Msg != OUT_CAN_LIST.RL_VirtualLimit_LegrestExt) && (Msg != OUT_CAN_LIST.RL_VirtualLimit_Height) && (Msg != OUT_CAN_LIST.RL_VirtualLimit_Tilt) &&
                (Msg != OUT_CAN_LIST.RR_VirtualLimit_All) && (Msg != OUT_CAN_LIST.RR_VirtualLimit_Relax) && (Msg != OUT_CAN_LIST.RR_VirtualLimit_Recline) &&
                (Msg != OUT_CAN_LIST.RR_VirtualLimit_Legrest) && (Msg != OUT_CAN_LIST.RR_VirtualLimit_LegrestExt) && (Msg != OUT_CAN_LIST.RR_VirtualLimit_Height) && (Msg != OUT_CAN_LIST.RR_VirtualLimit_Tilt))
            {
