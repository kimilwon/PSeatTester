...
{    
    public interface MyInterface
    {
        ...
        bool C_RelaxDnOnOff { set; }
        bool C_RelaxUpOnOff { set; }
        bool C_LegrestDnOnOff { set; }
        bool C_LegrestUpOnOff { set; }
        bool C_ReclineBwdOnOff { set; }
        bool C_ReclineFwdOnOff { set; }
        bool C_LegrestExtUpOnOff { set; }
        bool C_LegrestExtDnOnOff { set; }
...
//        }
        ...
        private void CheckPopData(MES_Control.__ReadMesData__ Data)
        {
            if (IOPort.GetAuto == false)
            {
        ...
        private void timer2_Tick(object sender, EventArgs e)
        {
            try
            {
                ...
                if(PopCtrol.isReading == true)
                {
                    ...
                    CheckPopData(PopCtrol.GetReadData);
                }
                ...
                if (led10.Value.AsBoolean != IOPort.GetSlide납입센서) led10.Value.AsBoolean = IOPort.GetSlide납입센서;
                ...
                if (panel2.Visible == false)
                {
                    ...
                    if ((IOPort.PinConnectionOnOff == true) || (IOPort.GetPinConnectFwd == true))
                    {
                        if (IOPort.SetJigDownOnOff == false) IOPort.SetJigDownOnOff = true;
                    }
                    else
                    {
                        if ((IOPort.PinConnectionOnOff == false) && (IOPort.GetPinConnectBwd == true))
                        {
                            if (IOPort.SetJigDownOnOff == true) IOPort.SetJigDownOnOff = false;
                        }
                    }
                ...
                if (RunningFlag == false)
                {
                    if (IOPort.GetAuto == true)
                    {
                        ...
                        {
                            if ((IOPort.GetStartSw == true) && (IOPort.GetJigUp == true) /*&& (IOPort.GetProductIn == true)*/  && (label16.Text != ""))
                            {
                    ...
                    if ((IOPort.GetResetSw == true) && (IOPort.GetJigUp == true) && (IOPort.GetProductIn == true) && (label16.Text != ""))
                    {
                        if (ProductOutFlag == true) ProductOutFlag = false;
        ...
        private void Processing()
        {
            ...
            switch (Step)
            {
                ...
                case 13:
                    ...
                    if (mData.Result != RESULT.REJECT) IOPort.TestOKOnOff = true;
                    //else IOPort.TestNGOnOff = true;                     
                    //if (IOPort.TestINGOnOff == true) IOPort.TestINGOnOff = false;
                    break;                
                case 14:
                    DeliveryPosMoveing(); 
        ...
        private void LegrestCheck(short Pos)
        {
            if (SpecOutputFlag == false)
            {
                ...
                if (Pos == 0)
                    C_LegrestUpOnOff = true;
                else C_LegrestDnOnOff = true;
            ...
            else
            {
                ...
                if ((mSpec.LegrestTestTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    if (Pos == 0)
                        C_LegrestUpOnOff = false;
                    else C_LegrestDnOnOff = false;
        ...
        private void LegrestExxtCheck(short Pos)
        {
            if (SpecOutputFlag == false)
            {
                ...
                if (Pos == 0)
                    C_LegrestExtUpOnOff = true;
                else C_LegrestExtDnOnOff = true;
            ...
            else
            {
                ...
                if ((mSpec.LegrestExtTestTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    if (Pos == 0)
                        C_LegrestExtUpOnOff = false;
                    else C_LegrestExtDnOnOff = false;
        ...
        private void SoundLavelCheck(short Pos)
        {
            ...
            for (int i = 0;i < plot2.Channels[0].Count;i++)
            {
                ...
                else if ((StartTime <= Time) && (Time <= xRunTime))
                {
                    if (RunCount == 0)
                    {
                        RunSound = Sound;
                        ...
                        if (ReclineMotorMoveEndFlag == false)
                        {
                            ...
                            if (mSpec.DeliveryPos.Recliner == 1)//Mid
                            {
                                if (ReclineMotorMoveEndFlag == false)
                                {
                                    ...
                                    {
                                        panel7.Visible = true;
                                        this.Location = new Point(this.Left + ((this.Width / 2) - (panel7.Width / 2)), 150);
//#if FUNCTION_IO_CONTROL
//                            if(ReclineFwdOnOff == true) ReclineFwdOnOff = false;
//                            if(ReclineBwdOnOff == true) ReclineBwdOnOff = false;
//#else
...
//                                        ReclineMotorMoveEndFlag = true;
        ...
        private void ledArrow9_ValueChanged(object sender, Iocomp.Classes.ValueBooleanEventArgs e)
        {
            ...
            C_LegrestExtUpOnOff = e.ValueNew;
            return;
        }
        ...
        private void ledArrow10_ValueChanged(object sender, Iocomp.Classes.ValueBooleanEventArgs e)
        {
            ...
            C_LegrestExtDnOnOff = e.ValueNew;
            return;
        }
        ...
        public bool C_LegrestExtUpOnOff
        {
            set
            {
        ...
        public bool C_LegrestExtDnOnOff
        {
            set
            {
