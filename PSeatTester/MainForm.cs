...
//        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (sevenSegmentAnalog1.Value.AsDouble != sData) sevenSegmentAnalog1.Value.AsDouble = sData;
            return;
        }
        ...
        private void CheckPopData()
        {
            ...
            if (IOPort.GetAuto == true)
            {
                ...
                if ((PopReadData.Check.Substring(0, 1) == "1") || (PopReadData.Check.Substring(1, 1) == "1"))
                    {
        ...
        private bool ResetButtonOnFlag = false;
                ...
                {                    
                    if (IOPort.GetAuto == true)
                    {
                        ...
                        else
                        {
                            ...
                            if (Flag == false)
                            {
                                if ((IOPort.GetJigUp == true) && (IOPort.GetProductIn == true) && (PopReadOk == true) && (ProductOutFlag == false) && (label16.Text == "")) PopReadOk = PopReadOkOld;
                            }
                        }
                    ...
                    if ((IOPort.GetResetSw == true) && (IOPort.GetProductIn == true) && (label16.Text != ""))
                    {
                        if (ResetButtonOnFlag == false)
                        {
                            ...
                            if (panel7.Visible == true) panel7.Visible = false;
                            ResetButtonOnFlag = true;
                        }
                    }
                    else
                    {
                        ResetButtonOnFlag = false;
                    }
                }
                else
                {
        ...
        {
            CanReWrite.LhRhSelect = comboBox3.SelectedItem.ToString() == "LH" ? LH_RH.LH : LH_RH.RH;
        ...
        private void ScreenInit(bool Flag = true)
        {
            if (Flag == true)
            {
        ...
        private void DisplaySpec()
        {
            if ((CheckItem.Recline == true) || (CheckItem.Relax == true) || (CheckItem.Height == true) || (CheckItem.Legrest == true) || (CheckItem.LegrestExt == true))
            {
                ...
                if (CheckItem.Recline == true)
                {
                    ...
                    if (CheckItem.Sound == true)
                    {
                        ...
                        //--------------- Fwd
                        if ((CheckItem.Relax == false) && (CheckItem.RelaxSeat == false))
                        {
            ...
            fpSpread1.ActiveSheet.Cells[27, 4].Text = mSpec.Sound.StartMax.ToString("0");
            fpSpread1.ActiveSheet.Cells[28, 4].Text = mSpec.Sound.RunMax.ToString("0");
        ...
        private void IOInCheck()
        {
            ...
            if ((CheckItem.Relax == false) && (CheckItem.Legrest == false) && (CheckItem.LegrestExt == false)) CheckItem.RelaxSeat = false;
            //----------------------------------------------------------------------
            //사양에 따라 모델 선택을 진행한다.
        ...
        private void Processing(object sender,EventArgs e)
        {
            ...
            switch (Step)
            {
                ...
                case 13:
                    ...
                    //리렉스 시트일 경우 판정을 진행하고 양품일때 도어를 열지만
                    //일반 파워 시트일 경우 리클라인 전진 소음을 측정하기 위해 판정을 하지 않는다.
                    if (CheckItem.RelaxSeat == true)
                    {
                        ResultCheck();
                ...
                default:  
                    ...
                    {                        
                        ...
                        {
                            //IOPort.TestINGOnOff = false;
                            if ((mData.Result != RESULT.REJECT) && (mData.InComing != RESULT.REJECT))
                            {
                                label16.Text = "OK";
        ...
        private void RelaxCheck(short Pos)
        {
            ...
            {
                if(Pos == 0)
                    label5.Text = "릴렉스 전류 측정 중 입니다.";
                else label5.Text = "릴렉스 리턴 전류 측정 중 입니다.";
                StepTimeFirst = ComF.timeGetTimems();
                StepTimeLast = ComF.timeGetTimems();
                SpecOutputFlag = true;
            ...
            else
            {
                ...
                if ((mSpec.RelaxTestTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    else
                    {
                        fpSpread1.ActiveSheet.Cells[3, 7].Text = mData.Relax.Result1 == RESULT.PASS ? "O.K" : "N.G";
                        fpSpread1.ActiveSheet.Cells[3, 7].ForeColor = mData.Relax.Result1 == RESULT.PASS ? Color.Lime : Color.Red;
                        SoundLavelCheck(SoundLevePos.RELAX_RETURN);
                        SoundCheck(SoundLevePos.RELAX_RETURN);
                    }
                    Step++;
                    SpecOutputFlag = false;
                    ComF.timedelay(500);
            ...
            else
            {
                ...
                if (Pos == 0)
                    ...
                    else
                    {
                        ...
                        SoundLavelCheck(SoundLevePos.RECLINE_FWD);
                        SoundCheck(SoundLevePos.RECLINE_FWD);
                    }
        ...
        private void LegrestCheck(short Pos)
        {
            ...
            {
                if (Pos == 0)
                    label5.Text = "레그레스트 전류 측정 중 입니다.";
                else label5.Text = "레그레스트 리턴 전류 측정 중 입니다.";
                StepTimeFirst = ComF.timeGetTimems();
                StepTimeLast = ComF.timeGetTimems();
                SpecOutputFlag = true;
            ...
            else
            {
                ...
                if ((mSpec.LegrestTestTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    if (Pos == 0)
                    {
                        ...
                        SoundLavelCheck(SoundLevePos.LEGREST);
                        SoundCheck(SoundLevePos.LEGREST);
                    }
                    else
                    {
                        ...
                        SoundLavelCheck(SoundLevePos.LEGREST_RETURN);
                        SoundCheck(SoundLevePos.LEGREST_RETURN);
                    }
        ...
        private void LegrestExxtCheck(short Pos)
        {
            if (SpecOutputFlag == false)
            {
                label5.Text = "레그레스트 EXT 전류 측정 중 입니다.";
                StepTimeFirst = ComF.timeGetTimems();
                StepTimeLast = ComF.timeGetTimems();
                SpecOutputFlag = true;
            ...
            else
            {
                ...
                if ((mSpec.LegrestExtTestTime * 1000) <= (StepTimeLast - StepTimeFirst))
                {
                    ...
                    else
                    {
                        ...
                        SoundLavelCheck(SoundLevePos.LEGEXT_RETURN);
                        SoundCheck(SoundLevePos.LEGEXT_RETURN);
                    }
        ...
        private void SoundCheck(short Pos)
        {
            ...
            else if (Pos == SoundLevePos.RECLINE_FWD)
            {
                if (mData.ReclineFwdSound.Test == true)
                {
                    ...
                    else mData.ReclineFwdSound.ResultRun = RESULT.PASS;

                    fpSpread1.ActiveSheet.Cells[27, 6].Text = mData.ReclineFwdSound.StartData.ToString("0");
                    fpSpread1.ActiveSheet.Cells[28, 6].Text = mData.ReclineFwdSound.RunData.ToString("0");

                    fpSpread1.ActiveSheet.Cells[27, 7].Text = (mData.ReclineFwdSound.ResultStart == RESULT.PASS) ? "O.K" : "N.G";
                    fpSpread1.ActiveSheet.Cells[27, 7].ForeColor = (mData.ReclineFwdSound.ResultStart == RESULT.PASS) ? Color.Lime : Color.Red;

                    fpSpread1.ActiveSheet.Cells[28, 7].Text = (mData.ReclineFwdSound.ResultRun == RESULT.PASS) ? "O.K" : "N.G";
                    fpSpread1.ActiveSheet.Cells[28, 7].ForeColor = (mData.ReclineFwdSound.ResultRun == RESULT.PASS) ? Color.Lime : Color.Red;
                }
            }
        ...
        //private bool ReclineDeliveryStep = false;
                    ...
                    if (ReclineDeliveryPosMove == true)
                    {
                        ...
                        if (ReclineMotorMoveEndFlag == false)
                        {
                            if (CheckItem.RelaxSeat == false)
                            {
                                ...
                                if (mSpec.DeliveryPos.Recliner == 1)//Mid
                                {
                                    if ((mSpec.DeliveryPos.NotRelaxStroke <= StrokeData) && (StrokeData < 900))
                                    {
                                        C_ReclineFwdOnOff = false;
        ...
        private void SendTestData()
        {
            ...
            string s = PopCtrol.CrateData(
                   ...
                   Min_1: -9999,
                   Max_1: -9999,
                   Min_2: (mData.Relax.Test == false) ? -9999 : (float)mSpec.Current.Relax.Min,
                   ...
                   Value4: (mData.Legrest.Test == false) ? -9999 : mData.Legrest.Data1,
                   Value5: (mData.LegrestExt.Test == false) ? -9999 : mData.LegrestExt.Data1,
        ...
        private void SaveData()
        {
            ...
            if (mData.InComing != RESULT.REJECT)
            {
                fpSpread2.ActiveSheet.Cells[RowCount, Col].BackColor = Color.White;
                fpSpread2.ActiveSheet.Cells[RowCount, Col].ForeColor = Color.Black;
        ...
        private bool isCheckItem
        {
            get
            {
                if ((CheckItem.Height == true) || (CheckItem.Legrest == true) || (CheckItem.LegrestExt == true) || (CheckItem.Recline == true) || (CheckItem.Relax == true) || (CheckItem.Sound == true))
                    return true;
                else return false;
            }
        }
